...
/*global Util, vnc2cast_frame_data, finish */
...
next_iteration = function () {
    if (iteration === 0) {
        frame_length = vnc2cast_frame_data.length;
        test_state = 'running';
    } else {
        corba.disconnect();
    }
...
queue_next_packet = function () {
    ...
    frame = vnc2cast_frame_data[frame_idx];
...
do_packet = function () {
    ...
    var frame = vnc2cast_frame_data[frame_idx];
