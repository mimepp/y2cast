...
1));this.pressTimer.setMidpoint(cc.p(1,0));this.pressTimer.setAnchorPoint(0,0);this.pressTimer.setPosition(cc.p(10,25));this.pressTimer.runAction(cc.RepeatForever.create(cc.ProgressTo.create(3,100)));this.pressTimer.tag=3002;a.addChild(this.pressTimer,1);var b=cc.Sprite.create(res.button_bottom_pressed_3);b.setAnchorPoint(0,0);b.setPosition(10,25);a.addChild(b,1);this.addChild(a,2);cc.eventManager.addListener(TouchEventListener,this);return!0},displayMenu:function(a){TOUCH_COUNT=0;this.getChildByTag(300).getChildByTag(3002).stopAllActions();
cc.eventManager.removeAllListeners();a=a||0;this.menu_layer=cc.Layer.create();this.menu_layer.tag=400;a=cc.LabelTTF.create("\u5f97\u5206: "+a,"Arial",20);a.setPosition(this.size_width/2,this.size_height/2+80);a.setColor(cc.color(39,64,139,0));var b=cc.Sprite.create(res.button_more_game),b=cc.MenuItemSprite.create(b,null,null,this.click_moreGame,this),c=cc.Sprite.create(res.button_retry),c=cc.MenuItemSprite.create(c,null,null,this.click_retry,this),b=cc.Menu.create(b,c);b.alignItemsHorizontallyWithPadding(20);
b.attr({x:this.size_width/2,y:this.size_height/2});this.menu_layer.addChild(a,0);this.menu_layer.addChild(b,0);this.addChild(this.menu_layer,3)},click_moreGame:function(){},click_retry:function(){this.menu_layer.setVisible(!1);this.pressTimer.setPercentage(0);this.pressTimer.runAction(cc.RepeatForever.create(cc.ProgressTo.create(3,100)));this.backgroundLayer.init();this.bearSprite.setPosition(this.size_width-70,105);this.bearSprite.init();this.backgroundLayer.addChild(this.bearSprite,1);this.backgroundLayer.bg_array.push(this.bearSprite);
this.penguinSprite.setPosition(this.size_width-58,this.size_height-45);this.penguinSprite.re_stand();cc.eventManager.addListener(TouchEventListener,this)}}),GameScene=cc.Scene.extend({onEnter:function(){this._super();var a=new GameLayer;this.addChild(a)}});var TOUCH_COUNT=0,TouchEventListener=cc.EventListener.create({event:cc.EventListener.TOUCH_ONE_BY_ONE,swallowTouches:!1,onTouchBegan:function(a,b){return!0},onTouchEnded:function(a,b){TOUCH_COUNT++;var c=b.getCurrentTarget();if(1==TOUCH_COUNT){var d=c.getChildByTag(300),d=d.getChildByTag(3001);d.playFreeFall();var e=c.getChildByTag(100),e=e.getChildByTag(1001);e.readyBaseBall()}2==TOUCH_COUNT&&(e=c.getChildByTag(100),e=e.getChildByTag(1001),d=c.getChildByTag(300),c=d.getChildByTag(3002),c.stopAllActions(),
d=d.getChildByTag(3001),e.playBaseBall(d,c.getPercentage()))}});var PenguinSprite=cc.Sprite.extend({landing_Y:null,p_reference:null,v_friction:null,h_friction:null,rate_X:null,rate_Y:null,move_time:null,current_X:null,current_Y:null,start_X:null,start_Y:null,start_point_X:null,milestone_number:null,ctor:function(){this._super();this.landing_Y=75;this.p_reference=cc.p(450,130);this.v_friction=this.h_friction=50;this.rate_Y=this.rate_X=0;this.time_interval=0.1;this.milestone_number=1},init:function(a){this.initWithFile(a)},re_stand:function(){this.milestone_number=
